...
export const MOCK_BALANCES: LeaveBalance[] = [
    ...
    {
        userId: 'u5', year: 2024, totalDays: 20, usedDays: 7, pendingDays: 7, totalHours: 16, usedHours: 2,
        sickQuota: 10, sickUsed: 2, casualQuota: 10, casualUsed: 5 // l13 (Sick, 2), l15 (Casual, 1), l16 (Casual, 3), l17 (Casual, 1) = 5 Casual.
    },
];
