...
export const MOCK_BALANCES: LeaveBalance[] = [
    {
        userId: 'u1', year: 2024, totalDays: 20, usedDays: 12, pendingDays: 0, totalHours: 16, usedHours: 4,
        sickQuota: 10, sickUsed: 4, casualQuota: 10, casualUsed: 8 // Consistent with leaves below
    },
    {
        userId: 'u2', year: 2024, totalDays: 20, usedDays: 0, pendingDays: 2, totalHours: 16, usedHours: 0,
        sickQuota: 10, sickUsed: 0, casualQuota: 10, casualUsed: 0 // Corrected based on empty approved leaves
    },
    {
        userId: 'u3', year: 2024, totalDays: 20, usedDays: 0, pendingDays: 0, totalHours: 16, usedHours: 0,
        sickQuota: 10, sickUsed: 0, casualQuota: 10, casualUsed: 0
    },
    {
        userId: 'u4', year: 2024, totalDays: 25, usedDays: 0, pendingDays: 0, totalHours: 16, usedHours: 0,
        sickQuota: 10, sickUsed: 0, casualQuota: 10, casualUsed: 0
    },
    {
        userId: 'u5', year: 2024, totalDays: 20, usedDays: 0, pendingDays: 7, totalHours: 16, usedHours: 0,
        sickQuota: 10, sickUsed: 0, casualQuota: 10, casualUsed: 0
    },
];
...
export const MOCK_LEAVES: LeaveRequest[] = [
    ...
    {
        id: 'l1', userId: 'u1', type: 'Regular', nature: 'Sick', startDate: '2024-01-10', endDate: '2024-01-12',
    ...
    {
        id: 'l3', userId: 'u1', type: 'Regular', nature: 'Casual', startDate: '2024-03-01', endDate: '2024-03-05',
    ...
    {
        id: 'l4', userId: 'u1', type: 'Regular', nature: 'Casual', startDate: '2024-04-10', endDate: '2024-04-11',
    ...
    {
        id: 'l5', userId: 'u1', type: 'Regular', nature: 'Casual', startDate: '2024-05-20', endDate: '2024-05-22',
    ...
    {
        id: 'l7', userId: 'u1', type: 'Regular', nature: 'Sick', startDate: '2024-07-15', endDate: '2024-07-15',
    ...
    {
        id: 'l18', userId: 'u2', type: 'Regular', nature: 'Casual', startDate: '2024-09-01', endDate: '2024-09-02',
    ...
    {
        id: 'l20', userId: 'u1', type: 'Regular', nature: 'Casual', startDate: '2024-11-20', endDate: '2024-11-25',
